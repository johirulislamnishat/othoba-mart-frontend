...
const AddProduct = () => {
    ...
    useEffect(() => {
        axios
            ...
            .then((res) => {
                ...
                let categoryname = all.map((element) => ({
    ...
    const handleCategorydrop = (catname) => {
        ...
        let defaultcategoryselected = categoryList.filter((cat) => {
            return cat.value === catname;
        });
        // console.log(defaultcategoryselected);
        setCategory(defaultcategoryselected[0]);
    };
    ...
    const handleSubmit = (values) => {
        ...
        formData.append("product_category", category?.label);
