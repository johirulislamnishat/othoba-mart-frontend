...
const PrivacyPolicy = () => {
    ...
    <div className='m-10'>
        <Link href = '/auth/login'>
            <a>
        <button className='text-sky-500 flex items-center gap-2 mb-10'><ArrowLeftOutlined /> Back</button>
        </a>
        </Link>
...
<h5 className='font-semibold mt-2'>What User Data We Collect</h5>
...
<h5 className='font-semibold mt-2'>Safeguarding and Securing the Data</h5>
We are committed to securing your data and keeping it confidential. [name] has done all in its power to prevent data theft, unauthorized access, and disclosure by implementing the latest technologies and software, which help us safeguard all the information we collect online.
...
<h5 className='font-semibold mt-2'>Restricting the Collection of your Personal Data</h5>
