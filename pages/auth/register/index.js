        ...
        {isTerms && (
          <div className="absolute z-10 bg-white h-full mx-2 lg:mx-16 p-3 border-2 border-gray-200 rounded-lg flex flex-col items-center">
            ...
            <p className="text-xs lg:w-3/4">
              Note: If there is insufficient space in the application form for
              the required information, the information is to be given in a
              separate annexure.
              <br />
            </p>
            <div className="flex flex-col">
              ...
              <p>
                (ii) Name of web hosting company (if not hosted by applicant):
              </p>
              <button
        ...
        {isNext && (
          <div className="absolute z-10 bg-white h-full mx-2 lg:mx-16 p-3 py-5 lg:p-10 border-2 border-gray-200 rounded-lg flex flex-col items-center">
            <div className="flex flex-col text-sm">
              <p>
                (iii) Type of server software used for processing commercial
                transactions:
              </p>
              <p>(iv) List of functionalities of server software:</p>

              <p>
                (v) Method/s of payment and collection used for commercial
                transactions:
              </p>
              <p>(vi) Type of security capabilities used:</p>
              <p>
                3. (i) Process flow of the entire commercial transaction from
                the time customer browse the Applicant’s web site for product
                information to the placement of order and delivery of the goods
                or services.
              </p>
              <p>
                4. Declaration (if the Applicant is not an individual, the
                declaration must be signed by two directors/partners or one
                director/partner and one secretary).
              </p>
              <p>
                (i) I hereby certify and declare that all the particulars
                furnished in this form are true and correct. Signature: Name:
                Designation: Company seal: Date:
              </p>
              <p>
                (ii) I hereby certify and declare that all the particulars
                furnished in this form are true and correct. Signature: Name:
                Designation: Company seal: Date
              </p>
              <button
