    ...
    return(
        ...
        <div className='min-w-full'>
          ...
          <div className="mx-4 sm:mx-16 p-4 border-2 border-gray-200">
              <h3 className='text-center text-2xl font-semi-bold mb-7'>Reset Password</h3>
            <form onSubmit={handleReset} className="flex flex-col gap-2 font-semibold text-sm">
             <label>Email</label>
             <input onChange={(e)=>setEmail(e.target.value)} type='password' required={true}
              ...
              <label>Confirm Password</label>
                <input onChange={(e)=>setPassword2(e.target.value)} type='password' required={true}
                  placeholder="Enter your password"
                  className="w-full p-2 mb-2 border-2 border-gray-200"
                />
              ...
              <button className="bg-sky-500 py-1 mt-2 text-white" type='submit' >Reset Password</button>
            </form>
            <div className="flex flex-col items-center gap-2 mt-5">
                <Link href='/auth/login'>
                  <a>
                <span className="text-sky-300 font-semibold cursor-pointer">
                 Go back to <span className="text-sky-500" > Login</span> page 
                </span>
                </a>
                </Link>
